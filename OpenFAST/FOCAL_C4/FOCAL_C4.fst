...
"FOCAL_C4_InflowFile_LC02.dat"               		InflowFile   - Name of file containing inflow wind input parameters (quoted string) 
...
"SeaState_LC02.dat"                			SeaStateFile    - Name of file containing sea state input parameters (quoted string)
