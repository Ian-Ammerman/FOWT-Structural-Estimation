...
"..\5MW_Baseline\Wind\IFW_H90m_13mps_Steady.dat"    InflowFile      - Name of file containing inflow wind input parameters (quoted string)
...
"NRELOffshrBsline5MW_OC4DeepCwindSemi_HydroDyn_NoWave.dat"    HydroFile       - Name of file containing hydrodynamic input parameters (quoted string)
...
True          SumPrint        - Print summary data to "<RootName>.sum" (flag)
         25   SttsTime        - Amount of time between screen status messages (s)
