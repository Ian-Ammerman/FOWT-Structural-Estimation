function K = FloatingStiffnessMatrix(btable, ttable, azimuth, omega)
...
if isempty(init_flag)
    ...
    % Elastic stiffness
    ke = trapz(btable.BlFract, btable.FlpStff .* btable.ddFmode1.^2);
...
kpt = sum(omega^2*kpt_con*cos(azimuth));
